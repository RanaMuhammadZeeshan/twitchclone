...
import bitsSupport from '/public/images/bits-support.gif'

const PrimeSubMenuHeader = ({ bitsMenu }) => {
  const primeTitle = 'claim with prime gaming'
  const bitsTitle = 'Use Bits to support streamers'

  const bitsDes =
    'When you use Bits in a channel, Twitch rewards the streamer and you create an exciting moment.'

  const primeDesc =
    'Support your favorite streamer, plus get monthly games and in-game loot, and loads more with Prime Gaming.'
    ...
    <React.Fragment>
      <div className="flex flex-col space-y-6">
        ...
        <div className="text-start">
          <p className="font-twitchFont text-sm text-whiteTextSecondary dark:text-darkTextPrimary tracking-wider">
            {bitsMenu ? bitsDes : primeDesc}
          </p>
        </div>
...
export default PrimeSubMenuHeader
